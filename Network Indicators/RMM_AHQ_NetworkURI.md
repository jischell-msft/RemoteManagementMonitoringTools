# Advanced Hunting Query for all network indicators

This query will look for any of the URL indicators in network connections. If a tool is intentionally being used, it can be commented out or removed from the listing.
...
let rmm_networkSet = datatable(URI:string,RMM_Tool:string)[
    ...
    'autoupdate.mikogo4.com','beamyourscreen',
    'download.mikogo4.com','beamyourscreen',
    'webdb.mikogo4.com','beamyourscreen',
    'webdbmirror.mikogo4.com','beamyourscreen',
    ...
    'xmpp.itsm-us1.comodo.com','Itarian',
    ...
    'atled.syspectr.com','Syspectr',
    'notify1.syspectr.com','Syspectr',
    'cdn.syspectr.com','Syspectr',
    'app.syspectr.com','Syspectr',
    'tm.syspectr.com','Syspectr',
    'console.syspectr.com','Syspectr',
    'icanhazip.tacticalrmm.io','TacticalRMM',
    'tacticalrmm.io','TacticalRMM',
    'teamviewer.com','TeamViewer',
    'teamviewer.cn','TeamViewer',
    'fixme.it','TechInline',
    'techinline.net','TechInline',
    'set.me','TechInline',
    'tsplus-remotesupport.com','TSplus',
    'secure-download-file.com','TSplus',
    'licenseapi.dl-files.com','TSplus',
    'securityapi.dl-files.com','TSplus',
    'monitoring.tsplus.net','TSplus',
...
| summarize FirstSeen=min(Timestamp), LastSeen=max(Timestamp), 
    ...
    AccountUpn, RemoteUrl, InitiatingProcessFileName 
;
rmmNetwork
```